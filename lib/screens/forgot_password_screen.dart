      ...
      body: BlocListener<AuthBloc, AuthState>(
        listener: (context, state) {
          if (state is AuthPasswordResetSuccess) {
            ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Successfully send mail')));
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Text('Enter the email address you used to create your account and we will email you a link to reset your password',textAlign: TextAlign.center,),
                SizedBox(height: 20,),
                CustomButton(onTap: () {
                  BlocProvider.of<AuthBloc>(context).add(ForgotPasswordRequested(
